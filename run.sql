...
-- Attention. The restrictors table is not set up properly 
-- so you often get courses which should be in the restrictors table

drop procedure if exists ElectedCourses$$

create procedure ElectedCourses(in stID int, out returnCourses varchar(60))
begin
